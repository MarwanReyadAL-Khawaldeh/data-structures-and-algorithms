...
const sortNumbers = (arr) => {
  // Solution code here...
  arr.sort(function (smallest, largest) {
    if (smallest > largest) {
      return 1;
    }
...
const sortByPrice = (arr) => {
  // Solution code here...
  arr.sort(function (lowest, hightest) {
    if (lowest.price > hightest.price) {
      return 1;
    }
    else if (lowest.price < hightest.price) {
      return -1;
    }
    else {
      return 0;
